...
from sailors_log.constants import DEV, PROD, KUBERNETES
...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,sailors-log.segelgruppe-kiel.de,sailors-log.magierdinge.de',
